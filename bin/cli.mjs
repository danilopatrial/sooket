/**
 * `sooket` CLI implementation — imported by the bin/sooket.mjs shebang
 * wrapper. Kept shebang-free so tests can import it: bundlers choke on
 * shebang lines when the checkout uses CRLF line endings (e.g. Windows CI).
 *
